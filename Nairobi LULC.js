...
var nairobi2002 = image2002.clip(nairobi);
...
//Clip to Nairobi County Boundary
var nairobi2022 = image2022.clip(nairobi);
...
Map.addLayer(nairobi2002, l7vizParams, "nairobi2002", false);
Map.addLayer(nairobi2022, l9vizParams, "nairobi2022", false);

//Centering to AOI
Map.centerObject(nairobi, 11.5);
...
var input2002 = nairobi2002.select(l7bands);

//Classes; [0-Water, 1-Built_up, 2-Vegetation, 3-Forest, 4-Bareland]
var training2002 = Built_up2002.merge(Vegetation2002)
  .merge(Water2002)
  .merge(Forest2002)
  .merge(Bareland2002);
...
var input2022 = nairobi2022.select(l9bands);

//Classes; [0-Water, 1-Built_up, 2-Vegetation, 3-Forest, 4-Bareland]
var training2022 = Built_up2022.merge(Vegetation2022)
  .merge(Water2022)
  .merge(Forest2022)
  .merge(Bareland2022);
...
Export.image.toDrive({
  image: classified2002,
  description: "Nai2002LULC",
  folder: "GEEAssignments",
  fileNamePrefix: "Nai2002LULC",
  scale: 10,
});
//2022
Export.image.toDrive({
  image: classified2022,
  description: "Nai2022LULC",
  folder: "GEEAssignments",
  fileNamePrefix: "Nai2022LULC",
  scale: 10,
});
